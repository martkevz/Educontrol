...
import com.educontrol.application.modelos.EstudianteRepository;

@Service
public class EstudianteController implements EstudianteRepository{
    ...
    public boolean existsById(Integer id) {
        return estudiante.existsById(id);
    }
