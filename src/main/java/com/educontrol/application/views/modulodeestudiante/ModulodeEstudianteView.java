...
public class ModulodeEstudianteView extends Composite<VerticalLayout> {
    ...
    public ModulodeEstudianteView() {
        ...
        textField3.setLabel("Nivel Academico");
        textField4.setLabel("Foto (URL)");
        datePicker2.setLabel("Fecha de Inscripción");
        datePicker2.setWidth("min-content");
        emailField.setLabel("Email");
        emailField.setWidth("min-content");
        textField5.setLabel("Número de identificación");
        textArea.setLabel("Dirección");
